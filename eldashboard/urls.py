...
urlpatterns = [
    ...
    path('list_templates', views.listtemplates, name='listtemplates'),
    ...
    path('template/<int:id>', views.updatetemplateform, name='updatetemplateform'),
    path('template', views.templateform, name='templateform'),
    path('removetemplate/<int:id>', views.removetemplate, name='removetemplate'),
    ...
    path('api/searchtemplates', api_views.searchtemplates, name='searchtemplates'),
    ...
    path('api/generatecustomreport', api_views.generatecustomreport, name='generatecustomreport'),
    ...
    path('api/downloadtempreport', api_views.downloadtempreport, name='downloadtempreport'),
    ...
    path('api/uploaddata', api_views.uploaddata, name='uploaddata'),
